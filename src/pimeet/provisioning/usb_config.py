"""
USB configuration reader for PiMeet provisioning.
...
class USBConfigReader:
    ...
    async def write_error_log(self, config_path: Path, error: str) -> None:
        ...
        """
        try:
            error_path = config_path.parent / "pimeet-error.log"
...
def create_sample_config() -> str:
    ...
    """
    return """# PiMeet USB Configuration
# Place this file on a USB drive as 'pimeet-config.yaml'
