"""
Provisioning service for PiMeet.
...
from pimeet.provisioning.captive_portal import CaptivePortal, APConfig
from pimeet.provisioning.usb_config import USBConfigReader, DeviceConfig
from pimeet.provisioning.setup_wizard import SetupWizard, WizardConfig
from pimeet.provisioning.network import NetworkManager, WiFiConfig, WiFiSecurity
from pimeet.provisioning.enrollment import DashboardEnrollment, EnrollmentStatus
...
class ProvisioningConfig:
    ...
    ap_ssid_prefix: str = "PiMeet-Setup"
...
def create_provisioning_service(config: Dict[str, Any]) -> ProvisioningService:
    ...
    prov_config = ProvisioningConfig(
        config_path=config.get('config_path', '/etc/pimeet'),
        setup_timeout=config.get('setup_timeout', 1800),
        ap_ssid_prefix=config.get('ap_ssid_prefix', 'PiMeet-Setup'),
