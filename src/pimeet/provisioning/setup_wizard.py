"""
Setup wizard web server for PiMeet provisioning.
        ...
        <div class="content">
            ...
            <div class="step" id="step3">
                ...
                <div class="form-group">
                    ...
                    <input type="url" id="dashboardUrl" placeholder="https://pimeet.company.com">
                </div>
            ...
            <div class="step" id="step4">
                <div class="success">
                    ...
                    <p style="margin-top: 16px; color: #6b7280;">
                        Your PiMeet device is configured.<br>
