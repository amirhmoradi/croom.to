"""
IR Remote Navigation for PiMeet Touch UI.

Provides support for controlling the PiMeet UI using standard
...
PIMEET_KEYMAP = IRKeymap(
    name="PiMeet Custom Remote",
    remote_type="pimeet",
    mappings={
        # Standard navigation
        "KEY_UP": IRAction.UP,
...
class IRRemoteService:
    """
    IR Remote Control Service for PiMeet UI.
