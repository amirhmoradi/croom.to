"""
Local Web Interface for PiMeet.

Provides browser-based access to PiMeet settings and controls
...
class LocalWebInterface:
    """
    Local web interface server for PiMeet configuration.

    Provides a simple web UI accessible at http://pimeet.local or
    ...
    def __init__(
        ...
        host: str = "0.0.0.0",
        port: int = 8080,
        static_path: str = "/usr/share/pimeet/web",
    ...
    async def _handle_get_logs(self, request: web.Request) -> web.Response:
        ...
        logs = []
        log_file = Path("/var/log/pimeet/pimeet.log")
...
<head>
    ...
    <title>PiMeet Configuration</title>
    <style>
