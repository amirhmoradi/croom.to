"""
Service management for PiMeet.

Handles lifecycle and coordination of all PiMeet services.
"""
...
class Service(ABC):
    """Abstract base class for all PiMeet services."""
