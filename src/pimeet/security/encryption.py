"""
Encryption services for PiMeet.
...
class LinuxKeyringStorage(SecureKeyStorage):
    ...
    def __init__(self, service_name: str = "pimeet"):
        """
...
def create_key_storage(
    ...
    **kwargs,
    ...
    if storage_type in ("keyring", "auto"):
        storage = LinuxKeyringStorage(kwargs.get("service_name", "pimeet"))
    ...
    storage_path = kwargs.get("storage_path", Path("/var/lib/pimeet/keys"))
