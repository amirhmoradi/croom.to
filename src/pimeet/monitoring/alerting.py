    ...
    async def send(
        ...
        try:
            ...
            headers = {
                ...
                "User-Agent": "PiMeet-Alerting/1.0",
            }
...
class EmailNotifier:
    ...
    async def send(
        ...
        try:
            ...
            from_addr = smtp_config.get("from_address", "pimeet@localhost")
            ...
            msg["Subject"] = f"[PiMeet {alert.severity.value.upper()}] {alert.rule_name}"
            msg["From"] = from_addr
            msg["To"] = ", ".join(to_addrs)

            # Plain text body
            text_body = f"""
PiMeet Alert Notification
==========================
...
---
This is an automated message from PiMeet Monitoring.
"""
...
<body>
<h2>PiMeet Alert Notification</h2>
...
<hr>
<p><small>This is an automated message from PiMeet Monitoring.</small></p>
</body>
</html>
"""
    ...
    async def send(
        ...
        try:
            ...
            payload = {
                ...
                "summary": f"PiMeet Alert: {alert.rule_name}",
                "sections": [{
...
class MQTTNotifier:
    ...
    async def send(
        ...
        try:
            ...
            topic = config.config.get("topic", "pimeet/alerts")
...
class AlertManager:
    ...
    def __init__(
        ...
        """
        self._storage_path = storage_path or Path("/var/lib/pimeet/alerts")
