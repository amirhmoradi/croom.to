...
On the first boot, the Croom device will update itself and do some dynamic runtime configuration, then reboot itself and enter into service. If you have a TV connected via HDMI, you can watch these steps in real-time. Otherwise, just wait 5-10 minutes until the system restarts.
